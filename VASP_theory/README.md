...
$$
E= \frac{ \Sigma_i^2 \int d^3 \vec{r_i} \phi_i^\ast(\vec{r_i}) \hat{h} \phi(\vec{r_i})}{ \Sigma_i^2 \int d^3 \vec{r_i} \phi_i^\ast(\vec{r_i}) \phi_i(\vec{r_i})}
$$
...
$$  
\phi = \frac{\chi_1 \pm \chi_2}{\sqrt{2\pm2S_{12}}}
$$  
